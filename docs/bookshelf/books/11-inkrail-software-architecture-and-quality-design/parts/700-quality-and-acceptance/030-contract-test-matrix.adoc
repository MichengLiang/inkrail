...
Contract test matrix maps 10 号书 contracts to architecture test locations.
...
Appendix D expands this matrix into a review checklist. The appendix does not replace this chapter's contract.
