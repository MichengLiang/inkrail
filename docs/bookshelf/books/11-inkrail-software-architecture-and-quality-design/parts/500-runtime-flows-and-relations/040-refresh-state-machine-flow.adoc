...
刷新状态机运行流在 project mode query 和 explicit `refresh` command 中复用。它实现 xref:../10-inkrail-cli-design/book.adoc#refresh-state-machine[10 号书刷新状态机, rel=implements-contract]。
