...
|`target targetHeadline targetStart raw edgeStart`

|反向一跳邻域
|`inkrail neighborhood in --label <label> --depth 1`
|`source sourceHeadline sourceStart raw edgeStart`

|正向两跳邻域
|`inkrail neighborhood out --label <label> --depth 2`
|`first firstHeadline second secondHeadline firstStart secondStart`

|反向两跳邻域
|`inkrail neighborhood in --label <label> --depth 2`
|`near nearHeadline far farHeadline nearStart farStart`
...
|`sourceHeadline targetHeadline start raw`
